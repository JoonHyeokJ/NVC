...
if __name__ == '__main__':
    ...
    colors_per_domain = {'target': cnames['red'], 'source': cnames['blue'], 'target_neg_view': cnames['yellow']}
    ...
    color = colors_per_domain['target_neg_view']
    # ax.scatter(source_tx, source_ty, c=color, label='source', marker='.')
    ax.scatter(target_tx_neg_view, target_ty_neg_view, c=color, label='target_neg_view', marker='.', edgecolors=color, s=3)
    # ax.scatter(source_tx, source_ty, c=color, label='source', marker=',')
    ...
    target_fig_name = 'plot_domain_w_negaug.jpg' if args.result_path == 'near_model' else os.path.basename(args.result_path)
