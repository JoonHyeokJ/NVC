...
default_cfgs = {'mae_base_patch16_224': timm.models.vision_transformer._cfg(
...
def create_mae(variant, pretrained=False, default_cfg=None, **kwargs):
    ...
    model = build_model_with_cfg(
        MAEVisionTransformer, variant, pretrained,
